...
def gen_test():
    ...
    x = (
        ...
        q,
        l,
        len([0, 10, 17, 29, 49, 62, 94, 123, 143, 151, 175, 215, 219, 233, 275, 293, 319, 341, 342, 388, 408, 425, 451, 467, 470])
    )
    print("---------")
    print("----ala123----")
    print("---------")
...
tests = [
    ...
    (  # uniform fuel
        [
            0, 35, 40, 112, 117, 124, 125, 132, 141, 169, 172, 186, 199, 225, 248, 249, 255, 266, 273, 282, 310, 333, 360, 371, 373, 374, 402, 418, 429, 432,
            466,
            490,
            493, 500, 502, 512, 514, 542, 544, 583, 586, 602, 613, 653, 656, 663, 664, 694, 721, 723, 739, 740, 753, 758, 773, 823, 847, 863, 877, 879, 880,
            902,
            906,
            916, 932, 934, 957, 959, 983, 993, 995
        ],
        [
            84, 75, 42, 25, 51, 40, 78, 30, 47, 58, 90, 50, 28, 75, 61, 25, 90, 98, 81, 90, 31, 72, 89, 68, 47, 10, 43, 61, 91, 96, 47, 86, 26, 80, 54, 1, 71,
            39,
            82,
            66, 0, 49, 86, 24, 32, 87, 19, 56, 23, 96, 80, 44, 8, 32, 50, 93, 10, 55, 70, 54, 81, 54, 96, 60, 58, 44, 59, 38, 57, 29, 18],
        80,
        1000,
        17),
    ( # gaussian mu=05, sigma=0.2 fuel
        [0, 35, 40, 52, 75, 97, 112, 117, 124, 125, 132, 141, 152, 169, 172, 186, 199, 217, 225, 237, 248, 249, 255, 266, 273, 282, 285, 306, 307, 309, 310,
         324,
         333, 360, 368, 369, 371, 373, 374, 402, 406, 412, 417, 418, 429, 432, 465, 466, 490, 493, 497, 498, 500, 502, 505, 512, 514, 542, 544, 545, 546, 553,
         557,
         583, 586, 602, 613, 648, 651, 653, 656, 658, 663, 664, 694, 697, 699, 721, 723, 739, 740, 753, 755, 758, 763, 769, 773, 823, 828, 847, 862, 863, 877,
         879,
         880, 883, 884, 902, 906, 916, 922, 932, 934, 935, 957, 959, 983, 993, 995],
        [68, 22, 36, 57, 29, 48, 53, 33, 23, 53, 69, 37, 43, 82, 38, 39, 98, 19, 65, 9, 38, 80, 74, 31, 40, 51, 24, 61, 94, 22, 10, 55, 47, 86, 46, 48, 46, 30,
         63,
         23, 73, 50, 60, 38, 31, 86, 59, 74, 53, 102, 57, 29, 65, 58, 3, 47, 69, 66, 43, 25, 59, 27, 76, 43, 31, 38, 33, 38, 35, 42, 54, 61, 27, 30, 41, 51, 51,
         9,
         84, 32, 86, 22, 30, 44, 45, 34, 64, 13, 71, 33, 75, 41, 22, 58, 94, 48, 52, 42, 32, 34, 23, 21, 51, 82, 60, 59, 54, 32, 53],
        80,
        1000,
        17),
    # gen_test()
